CC = g++
FILES = src/main.cpp src/instructions/convert_methods/convert_methods.cpp src/instructions/instruction_parser/instruction_parser.cpp src/misc/auxiliar_methods/auxiliar_methods.cpp src/misc/input_methods/input_methods.cpp
