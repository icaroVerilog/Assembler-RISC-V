...
std::string Convert_methods::m_binary_to_string(std::string funct7, std::string reg1, std::string reg2, std::string funct3, std::string dest_reg, std::string opcode){
